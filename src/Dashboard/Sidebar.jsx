...
const Sidebar = () => {
    ...
    return (
        <div className="flex flex-col justify-between h-screen">
            <div className="w-44">
                <img className="w-32 my-4" src={img} alt="" />
                <div className="flex flex-col gap-1">
                    <Link> <button className="flex items-center gap-2 py-2 border text-left  pl-2 border-blue-600 rounded hover:bg-blue-600 hover:text-white w-full"><BsFillPeopleFill className="text-lg" /> <span>মোট সদস্য</span></button></Link>
